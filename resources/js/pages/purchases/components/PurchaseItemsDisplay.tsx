...
interface PurchaseItemsDisplayProps {
    items: PurchaseItem[];
    subtotal: number;
    tax: number;
    discount: number;
...
export default function PurchaseItemsDisplay({
    items,
    subtotal,
    tax,
    discount,
    total,
}: PurchaseItemsDisplayProps) {
                        ...
                        {items.map((item) => (
                            ...
                            >
                                ...
                                <TableCell className="text-right text-white">
                                    ...
                                    >
                                        {item.qty_received} {item.item.unit}
                                    </span>
                                </TableCell>
                                <TableCell className="text-right text-white">
                                    {Number(item.cost).toLocaleString('id-ID', {
                                        style: 'currency',
                                        currency: 'IDR',
